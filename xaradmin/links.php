...
function sitetools_admin_links()
{
    ...
    $data['skiplocal']      = xarModGetVar('sitetools','links_skiplocal');
    $data['links_follow']   = xarModGetVar('sitetools','links_follow');
    $data['method']         = xarModGetVar('sitetools','links_method');
    //common menu link
